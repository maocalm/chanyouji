 ...
 */
public class AbroadCountryAdapter extends BaseAdapter{
    private Context context;
    private List<ParseSearchCountry.AbroadCountry> list;
    private LayoutInflater inflater;

    public AbroadCountryAdapter(Context context, List<ParseSearchCountry.AbroadCountry> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ParseSearchCountry.AbroadCountry abroadCountry = list.get(position);
        viewHolder.country.setText(abroadCountry.getName());
