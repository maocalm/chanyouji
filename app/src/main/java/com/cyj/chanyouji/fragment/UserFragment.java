...
import com.cyj.chanyouji.adapter.UserAdapter;
...
public class UserFragment extends Fragment {
    ...
    private String url = JsonUrl.USER;
    private String url1 = "";
    private String url2 ="";
    private int page = 1;
    private String q;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.pager_user,container,false);
    ...
    private void refresh(String url1, int page, String url2, String q) {
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                List<ParseUser.User> datas = ParseUser.parseData(result);
                if(list.size()>0){
